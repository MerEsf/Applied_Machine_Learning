...
kmeans.fit(X)         # k-means supports the predict method and so we can call the fit
                      # and predict methods separately. later methods like agglomerative
                      # clustering do not and must perform the fit and predict in a single step
